...
fn priority_exact_over_suffix() {
    let rules = "suffix:.example.com=reject,exact:api.example.com=proxy,default=unresolved";
    assert_eq!(
...
fn priority_exact_vs_cidr4() {
    let rules = "cidr4:10.0.0.0/8=reject,exact:10.1.2.3=proxy,default=unresolved";
...
fn priority_suffix_vs_cidr4_overlap() {
    ...
    let rules = "suffix:.svc=proxy,cidr4:192.168.0.0/16=reject,default=unresolved";
...
fn priority_suffix_over_default_when_exact_misses() {
    let rules = "exact:api.example.com=proxy,suffix:.example.com=reject,default=unresolved";
    assert_eq!(
