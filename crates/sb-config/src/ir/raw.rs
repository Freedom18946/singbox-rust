...
//!
//! ### DNS nested boundary pilot (WP-30d) / owner stabilization (WP-30ar)
//!
//! The DNS subtree's strict Raw owner now lives in [`super::dns_raw`]:
//! [`super::dns_raw::RawDnsServerIR`], [`super::dns_raw::RawDnsRuleIR`],
//! [`super::dns_raw::RawDnsHostIR`], and [`super::dns_raw::RawDnsIR`].
//!
//! This file keeps the broader Raw boundary entry point (`RawConfigRoot`) and
//! re-exports the DNS Raw types for compatibility, but it no longer owns the
//! DNS subtree implementation itself.
//!
...
//!
//! ### Phase boundaries that remain elsewhere
//!
