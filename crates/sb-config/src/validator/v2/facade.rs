...
/// Lightweight schema validation coordinator for root, nested block,
/// deprecation, security, and TLS capability checks.
///
/// 轻量 schema 校验编排器：统一调用根节点、嵌套块、弃用项、安全项与 TLS 能力检查。
