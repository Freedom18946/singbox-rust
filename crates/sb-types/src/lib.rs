...
impl IssueCode {
    ...
    pub const fn as_str(&self) -> &'static str {
        match self {
            Self::CliInvalidArg => "CliInvalidArg",
            Self::CliIoFail => "CliIoFail",
            Self::UnknownField => "UnknownField",
            Self::MissingRequired => "MissingRequired",
            Self::TypeMismatch => "TypeMismatch",
            Self::RangeExceeded => "RangeExceeded",
            Self::InvalidEnum => "InvalidEnum",
            Self::Conflict => "Conflict",
            Self::Deprecated => "Deprecated",
            Self::InvalidType => "InvalidType",
            Self::OutOfRange => "OutOfRange",
            Self::DuplicateTag => "DuplicateTag",
            Self::SchemaInvalid => "SchemaInvalid",
            Self::SchemaMissingField => "SchemaMissingField",
            Self::SchemaTypeMismatch => "SchemaTypeMismatch",
            Self::SchemaRangeInvalid => "SchemaRangeInvalid",
            Self::MinimizeSkippedByNegation => "MinimizeSkippedByNegation",
            Self::TlsHandshakeTimeout => "TlsHandshakeTimeout",
            Self::TlsHandshakeProtocol => "TlsHandshakeProtocol",
            Self::TlsCertInvalid => "TlsCertInvalid",
            Self::NetTimeout => "NetTimeout",
            Self::NetRefused => "NetRefused",
            Self::NetProto => "NetProto",
            Self::NetCert => "NetCert",
            Self::NetOther => "NetOther",
            Self::UpstreamTimeout => "UpstreamTimeout",
            Self::UpstreamIcmp => "UpstreamIcmp",
            Self::UpstreamRefused => "UpstreamRefused",
            Self::UpstreamOther => "UpstreamOther",
            Self::InsecureBinding => "InsecureBinding",
        }
    }
}
