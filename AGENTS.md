...
- Current verified total after the 2026-03-12 update: `34 / 60` behaviors are `Both-Covered` (`56.7%`).
...
4. `p1_urltest_auto_select_replay` only after Rust URLTest auto-selection semantics match Go
