...
| `L20.2.2` | ✅ PASS | `cargo test -p sb-config tls_quic_ech -- --nocapture`；`cargo test -p sb-config test_parse_experimental_block -- --nocapture` | `reports/l20/L20_2_2_QUIC_ECH_MODE_SWITCH.md`；`crates/sb-config/src/validator/v2/outbound.rs` |
