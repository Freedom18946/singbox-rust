...
| PX-003 | `option/{route.go,rule.go,rule_action.go,rule_dns.go,rule_set.go}` | `crates/sb-config/src/{ir/mod.rs,validator/v2.rs}` + `crates/sb-core/src/router/*` | MAJOR_DIFF | FAIL | FAIL | None | `go_fork_source/sing-box-1.12.14/option/route.go#L5` `go_fork_source/sing-box-1.12.14/option/rule.go#L69` `go_fork_source/sing-box-1.12.14/option/rule_action.go#L16` `go_fork_source/sing-box-1.12.14/option/rule_dns.go#L70` `go_fork_source/sing-box-1.12.14/option/rule_set.go#L20` `crates/sb-config/src/ir/mod.rs#L1109` `crates/sb-config/src/ir/mod.rs#L1397` `crates/sb-config/src/ir/mod.rs#L1497` `crates/sb-config/src/validator/v2.rs#L1713` `crates/sb-config/src/validator/v2.rs#L1763` | Missing rule actions/logical rules/DNS rule schema; rule_set inline/format/version behavior diverges; route defaults/options incomplete; parser bug maps domain_suffix -> domain. | Implement full rule+DNS rule schema + actions; add logical rules + listable parsing; align rule_set inline/format inference/version; fix domain_suffix mapping; add tests. |
...
| PX-005 | `route/{router.go,route.go,conn.go,dns.go,network.go}` | `crates/sb-core/src/router/{engine.rs,mod.rs,rules.rs,sniff.rs,process_router.rs,runtime.rs}` + `crates/sb-core/src/context.rs` + `crates/sb-core/src/endpoint/mod.rs` | MAJOR_DIFF | FAIL | FAIL | None | `go_fork_source/sing-box-1.12.14/route/router.go#L24` `go_fork_source/sing-box-1.12.14/route/route.go#L61` `go_fork_source/sing-box-1.12.14/route/conn.go#L58` `go_fork_source/sing-box-1.12.14/route/dns.go#L23` `go_fork_source/sing-box-1.12.14/route/network.go#L57` `crates/sb-core/src/router/engine.rs#L612` `crates/sb-core/src/router/rules.rs#L11` `crates/sb-core/src/context.rs#L233` `crates/sb-core/src/endpoint/mod.rs#L293` | Rust router is decision-only; no runtime routing, rule action execution, DNS hijack/fakeip integration, or connection/network manager parity. | Implement Go-style routing runtime + action pipeline + connection/network parity; add end-to-end tests. |
