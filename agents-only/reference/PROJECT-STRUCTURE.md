...
- 仓库状态：L1-L25 + MT-* 维护/验收线已关闭；MT-REAL-02 REALITY 本地主线已封箱（T3 收口）。当前状态与下一步以 `agents-only/active_context.md` 为准；REALITY 历史长报告见 `agents-only/archive/mt_real_02/mt_real_02_baseline.md` + `agents-only/mt_real_02_evidence/`
