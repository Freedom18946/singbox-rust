...
Objective: compare `singbox-rust` against Go reference `go_fork_source/sing-box-1.13.13` for functional, type, API, comment, and directory parity.
...
| Repo structure gaps | `go_fork_source/sing-box-1.13.13/{clients,include,release,experimental}` | De-scoped libbox/locale/mobile/release artifacts |
