...
**当前执行焦点（短周期）**: **L21 连续 wave 推进中**，当前落点为 **wave#116**，聚焦 **router_query_type_matching 测试样例 default 去 silent direct fallback**
...
- 尚余 `6` 个文件、`24` 处 `default=direct`。
- 继续按“一波一文件”推进；高风险文件留到后段集中处理。
- 当前 V7 口径：`l21.113-wave116-v1`（292 assertions）。
