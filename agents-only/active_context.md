...
**当前执行焦点（短周期）**: **L21 连续 wave 推进中**，当前落点为 **wave#114**，聚焦 **router_udp_rules 测试样例 default 去 silent direct fallback**
...
- 尚余 `8` 个文件、`29` 处 `default=direct`。
- 继续按“一波一文件”推进；高风险文件留到后段集中处理。
- 当前 V7 口径：`l21.111-wave114-v1`（288 assertions）。
