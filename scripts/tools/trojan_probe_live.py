...
BRIDGE_CLASS_PATTERNS: list[tuple[str, str]] = [
    ...
    # TLS sub-class signals — must precede the catch-all TLS / SSL
    # patterns below. These mirror common rustls / native-tls error
    # phrasings so a future authorized live run can distinguish a
    # cert-trust failure from an SNI mismatch without reading raw text.
    ("invalid peer certificate: unknownissuer", "tls_cert_unknown_issuer"),
    ("unknown issuer", "tls_cert_unknown_issuer"),
    ("unknownissuer", "tls_cert_unknown_issuer"),
    ("self-signed certificate", "tls_cert_unknown_issuer"),
    ("self signed certificate", "tls_cert_unknown_issuer"),
    ("certificate signed by unknown authority", "tls_cert_unknown_issuer"),
    ("untrusted root", "tls_cert_unknown_issuer"),
    ("invalid peer certificate: notvalidforname", "tls_name_mismatch"),
    ("notvalidforname", "tls_name_mismatch"),
    ("certificate not valid for name", "tls_name_mismatch"),
    ("hostname mismatch", "tls_name_mismatch"),
    ("name mismatch", "tls_name_mismatch"),
    ("subjectaltname", "tls_name_mismatch"),
    ("invalid peer certificate: expired", "tls_cert_expired"),
    ("certificate has expired", "tls_cert_expired"),
    ("certificate expired", "tls_cert_expired"),
    ("invalid dns name", "tls_invalid_dns_name"),
    ("invalid server name", "tls_invalid_dns_name"),
    ("received fatal alert", "tls_alert"),
    ("alertdescription", "tls_alert"),
    ("alert: handshake_failure", "tls_alert"),
    ("alert: bad_certificate", "tls_alert"),
    ("peerincompatibleerror", "tls_protocol_version"),
    ("no protocols in common", "tls_protocol_version"),
    ("unsupported protocol version", "tls_protocol_version"),
    ("inappropriate handshake message", "tls_handshake_failure"),
    ("invalid clienthello", "tls_handshake_failure"),
    ("invalid serverhello", "tls_handshake_failure"),
    ("tls handshake failed", "tls_handshake_failure"),
    ("handshake failure", "tls_handshake_failure"),
    # Generic TLS catch-alls (last among TLS).
