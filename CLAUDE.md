...
- **阶段**: **L18 认证替换（MIG-02 ACCEPTED，Phase 2 待执行）**
...
- **双核黄金基准**（`labs/interop-lab/docs/dual_kernel_golden_spec.md`）是 L18 Phase 2+ 的唯一行为对齐权威。
...
├── planning/                 # S-tier: 仅当前 phase 活跃规划
│   └── L18-PHASE2.md
...
| L18 Phase 2 工作包 | `agents-only/planning/L18-PHASE2.md` | S |
